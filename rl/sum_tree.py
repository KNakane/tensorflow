import numpy
# Based on https://github.com/y-kamiya/machine-learning-samples/blob/7b6792ce37cc69051e9053afeddc6d485ad34e79/python3/reinforcement/dqn/sum_tree.py
class SumTree:
    write = 0
    ...
    def get(self, s):
        ...
        dataIdx = idx - self.index_leaf_start
