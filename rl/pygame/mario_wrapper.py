...
def main(argv):
    env = gym_super_mario_bros.make(FLAGS.env)
...
if __name__ == '__main__':
    flags = tf.app.flags
    FLAGS = flags.FLAGS
    flags.DEFINE_string('env', 'SuperMarioBros-v0', 'Choise Agents -> [SuperMarioBros-v0, SuperMarioBros-v1, SuperMarioBros-v2, SuperMarioBros-v3, SuperMarioBros2-v0, SuperMarioBros2-v1s]')
    ...
    flags.DEFINE_integer('step', '5000', 'Input max steps')
